...
const imperativePlugins: Plugin[] = [
  ElMessage as unknown as Plugin,
  ElMessageBox as unknown as Plugin,
  ElNotification as unknown as Plugin,
  ElLoading as unknown as Plugin,
]
...
export { provideGlobalConfig, zhCn }
